...
let ProglinealPage = class ProglinealPage {
    ...
    onSubmit() {
        ...
        this.apiService.linear(this.form).subscribe((data) => {
            this.errorServ = false;
            if (data["error"]) {
                this.solucion = null;
                this.errorRest = true;
...
ProglinealPage = tslib_1.__decorate([
    Component({
...
export { ProglinealPage };
//# sourceMappingURL=proglineal.page.js.map